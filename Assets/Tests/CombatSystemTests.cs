...
public class CombatSystemTests
{
    ...
    public void Setup()
    {
        ...
        m_combatPrefab = Resources.Load<GameObject>("Prefabs/CombatSystem");
    }
    ...
    public IEnumerator EnemySpawnTest()
    {
        ...
        m_combatPrefab.GetComponent<FirstStrikeChance>().SetType(CheckType.Random);
        m_combatPrefab.GetComponent<FirstStrikeChance>().SetSuccessTest(50.0f);
        m_combatPrefab.AddComponent<GenerateGrids>();
        m_combatPrefab.AddComponent<CombatCursorController>();
        m_combatPrefab.AddComponent<CombatUIController>();
        ...
        List<GameObject> enemyList = CombatController.GenerateEnemiesTest();
    ...
    public IEnumerator PlayerActionsTest()
    {
        ...
        char1.AddComponent<ActionController>();
    ...
    public IEnumerator BattleEndTest()
    {
        ...
        CombatController.BattleEndTest(m_party, m_enemies);
